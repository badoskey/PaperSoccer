...
namespace Bado
{
	...
	{	
		...
		options[0].setCharacterSize(this->_data->scale_width*40);
		options[0].setString("Singleplayer");
		options[0].setPosition(this->_data->scale_width*SCREEN_WIDTH/2.f-options[0].getGlobalBounds( ).width/2,
			this->_data->scale_height*SCREEN_HEIGHT*2.f/8.f-options[0].getGlobalBounds( ).height/2);

		options[1].setFont(this->_data->assets.GetFont( "font"));
		options[1].setCharacterSize(this->_data->scale_width*40);
		options[1].setString("Multiplayer");
		options[1].setPosition(this->_data->scale_width*SCREEN_WIDTH/2.f-options[1].getGlobalBounds( ).width/2,
			this->_data->scale_height*SCREEN_HEIGHT*4.f/8.f-options[1].getGlobalBounds( ).height/2);
	
	
		options[2].setFont(this->_data->assets.GetFont( "font"));
		options[2].setFillColor(sf::Color::White);
		options[2].setCharacterSize(this->_data->scale_width*40);
		options[2].setString("Back");
		options[2].setPosition(this->_data->scale_width*SCREEN_WIDTH/2.f-options[2].getGlobalBounds( ).width/2,
			this->_data->scale_height*SCREEN_HEIGHT*6.f/8.f-options[2].getGlobalBounds( ).height/2);
	...
	void OptionsState::Update( float dt)
	{
		...
		if(pick>-1){
			...
			options[3].setCharacterSize(this->_data->scale_width*40);
			options[3].setString(this->_data->players[0]);
			options[3].setPosition(this->_data->scale_width*SCREEN_WIDTH/2.f-options[3].getGlobalBounds( ).width/2,
				this->_data->scale_height*SCREEN_HEIGHT*2.f/8.f-options[3].getGlobalBounds( ).height/2);

			options[4].setFont(this->_data->assets.GetFont( "font"));
			options[4].setFillColor(sf::Color::White);
			options[4].setCharacterSize(this->_data->scale_width*40);
			options[4].setString(this->_data->players[1]);
			options[4].setPosition(this->_data->scale_width*SCREEN_WIDTH/2.f-options[4].getGlobalBounds( ).width/2,
				this->_data->scale_height*SCREEN_HEIGHT*4.f/8.f-options[4].getGlobalBounds( ).height/2);


			options[5].setFont(this->_data->assets.GetFont( "font"));
			options[5].setFillColor(sf::Color::White);
			options[5].setCharacterSize(this->_data->scale_width*40);
			options[5].setString("Back");
			options[5].setPosition(this->_data->scale_width*SCREEN_WIDTH/2.f-options[5].getGlobalBounds( ).width/2,
				this->_data->scale_height*SCREEN_HEIGHT*6.f/8.f-options[5].getGlobalBounds( ).height/2);
